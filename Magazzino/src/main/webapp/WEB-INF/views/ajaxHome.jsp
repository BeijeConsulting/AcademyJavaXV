...
<form>
  ...
  <input type="submit" value="Inserisci Prodotto" onclick="addProduct(document.getElementById('name').value, document.getElementById('typology').value, document.getElementById('quantity').value, document.getElementById('description').value)">
</form>
<br><br><br><br><br><br>
<form>
  <label for="id">ID:</label><br>
  <input type="text" name="id" id="id" value=""><br>
  <input type="submit" onclick="searchP(document.getElementById('id').value)" value="Ricerca prodotto">
</form>
