public abstract class SAPA extends Azienda implements SASINTERFACE{
    ...
    public SAPA (String settore, String name, String registeredOffice, String PIVA, String tipo, boolean pubblica, boolean profit, int capSociale, int employees, int partner){
