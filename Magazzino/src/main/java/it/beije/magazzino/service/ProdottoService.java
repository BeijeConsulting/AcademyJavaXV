...
import static it.beije.magazzino.repository.ProdottoRepository.*;
...
public class ProdottoService {
    ...
    public List<Prodotto> findByTipologiaAndQuantita(String tipologia, Integer quantita) {
        return prodottoRepository.findByTipologiaAndQuantita(tipologia, quantita);
    }

    public List<Prodotto> findAllContains(String nome, Integer quantita) {
        return prodottoRepository.findAll(where(morethatQuantita(quantita)).and(nomeContains(nome)));
    }
}
