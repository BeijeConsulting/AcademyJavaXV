<html>
   ...
   <body>
      ...
      <ul>
         ...
         <li><a href="./productbyid-form">Pagina che restituisce il dettaglio del prodotto tramite id</a></li>
         ...
         <li><a href="./productbynameordescription-form"> Pagina che restituisce la lista dei prodotti di una ricerca per nome e/o descrizione</a></li>
